/* second linked copy of rotaterpy in the retail ROM; the first (0xAF8C0)
 * is an older vintage still in asm. Rename to match splat labels. */
#define guRotateRPYF guRotateRPYF_2
#define guRotateRPY guRotateRPY_2
/**************************************************************************
 *									  *
