/* The retail link resolved alLoadParam to the game-side audio lib copy at
 * 0x80026AF0; this libaudio copy shipped as dead code. Rename so our link
 * reproduces that binding. */
#define alLoadParam alLoadParam_dead
/*====================================================================
 * load.c
 *
